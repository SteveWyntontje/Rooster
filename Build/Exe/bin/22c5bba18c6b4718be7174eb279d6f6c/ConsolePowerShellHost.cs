...
namespace PowerShellToolsPro.Packager.ConsoleHost
{
	class Program
	{
        static int Main(string[] args)
        {
            ...
            if (WriteResourceToFile("Rooster.Modules.zip", moduleZip))
            {
            ...
            String script;
            using (var stream = Assembly.GetExecutingAssembly().GetManifestResourceStream("Rooster.script.ps1"))
            {
        ...
        private static string Decrypt(string cipherString)
        {
            ...
            string key = "915e1bd3-ddc1-47d9-b18e-";
